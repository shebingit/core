...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('base_app', '0058_delete_pm_projectdoc_module'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pdev_name', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='base_app.user_registration')),
